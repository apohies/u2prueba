...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b></b>U2</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="{{asset('AdminLTE-2.3.11/dist/img/avatar5.png')}}" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="{{asset('AdminLTE-2.3.11/dist/img/avatar5.png')}}" class="img-circle" alt="User Image">

                <p>
                  {{Auth::user()->name}} - {{Auth::user()->nick}} 
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      @if( auth::user()->role == 1)
      <li class="active"><a href="{{route('inicio')}}"><i class="fa fa-users"></i> <span>Usuarios registrados</span></a></li>

      @endif
        <li><a href="{{route('hobby.crear')}}"><i class="fa fa-link"></i> <span>Ingresar Hobbies </span></a></li>

        <li><a href="{{route('hobby.show')}}"><i class="fa fa-link"></i> <span> Ver mis Hobbies </span></a></li>
